  ...
  <body>
	<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr background="img/bg.jpg">
	    <td>
	    <form action="servlet/ShopHandleServlet?type=login" method="post">
		    <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
		      <tr>
		      ...
		      <tr>
		        <td height="228" colspan="4">
			        <table width="60%" border="1" align="center" cellpadding="0" cellspacing="0">
			          <tr>
			            <td width="46%" height="55" align="right">店铺名称：</td>
			            <td align="center"><input type="text" name="shopName" id="shopName"></td>
			          </tr>
			          <tr>
