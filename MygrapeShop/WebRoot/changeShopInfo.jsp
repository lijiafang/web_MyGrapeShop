...
<html>
  ...
  <form action="servlet/ShopHandleServlet?type=changeShopInfo" method="post">
		      ...
		      <tr>
		        <td width="75%" height="371" align="right">
			        <table width="70%" border="1" align="right" cellpadding="0" cellspacing="0">
			          <tr>
			            <td height="55" align="right">原始店铺名称：</td>
			            <td align="center"><input type="text" name="oldShopName" id="oldShopName" onfocus="showOldShopNameTip()" onblur="hideOldShopNameTip();checkOldInfo()"></td>
			           
			            <td></td>
			          </tr>
			          <tr>
	    				<td></td>
	    				<td><label id="oldShopNameTip"></label></td>
	    				<td></td>
	    			  </tr>
		        ...
		        <td width="25%">
			        <table width="87%" border="0" align="left" cellpadding="0" cellspacing="0">
			          <tr>
			            <td height="63"><label id="oldShopNameNews"></label></td>
			          </tr>
			          <tr>
