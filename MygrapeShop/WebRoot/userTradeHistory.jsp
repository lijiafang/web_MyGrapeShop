<%@page import="model.HistoryRecordBean"%>
<%@page import="model.OrdersBean"%>
    ...
    <td height="183">
	    <table width="95%" border="1" align="center" cellpadding="0" cellspacing="0">
	      ...
	      for(int i=0;i<al.size();i++){
	      	HistoryRecordBean hrb=(HistoryRecordBean)al.get(i);
	       %>
	      <tr align="center">
	        <td height="48"><%=hrb.getOrderId() %></td>
	        <td><%=hrb.getGoodsId() %></td>
	        <td><%=hrb.getShopId() %></td>
	        <td><%=hrb.getTotalPrice() %></td>
	      </tr>
	      <%
	      	}
	       %>
