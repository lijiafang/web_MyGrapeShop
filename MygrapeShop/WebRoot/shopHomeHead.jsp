...
<html>
  ...
  <tr>
    <td width="3%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="56" align="center" bgcolor="#FFCCFF"><a href="servlet/GoodsHandleServlet?type=showByPage" target="_top"></a></td>
        <td align="center" bgcolor="#FFCCFF"><a href="aboutOurTeam.jsp" target="_top">关于我们</a></td>
        <td align="center" bgcolor="#FFCCFF"><a href="servlet/ShopHandleServlet?type=exit">退出</a></td>
      </tr>
    </table></td>
  </tr>
</table>
